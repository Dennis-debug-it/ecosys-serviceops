...
namespace Ecosys.Infrastructure.Migrations.AppDb
{
    ...
    [Migration("20260513193541_WorkOrderExecutionEvidenceReports")]
    partial class WorkOrderExecutionEvidenceReports
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.EmailDeliveryLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.EmailOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.EmailSetting", b =>
                {
                    ...
                    b.Property<bool>("OverrideSmtpSettings")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("UsePlatformDefaults")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.IntakeProtocol", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("LastTriggerStatus")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformDocumentTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("ShowTenantBranding")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("platform_document_templates", (string)null);
                });

            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformExpense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("platform_expenses", (string)null);
                });

            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformInvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformLead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformQuotation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("platform_quotations", (string)null);
                });

            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformQuotationLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("platform_quotation_lines", (string)null);
                });

            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Property<DateTime?>("TrialExtendedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("TrialExtendedByUserId")
                        .HasColumnType("uuid");

                    b.Property<bool>("TrialExtensionUsed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.TenantNotificationRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "RecipientGroup", "Email")
                        .IsUnique();

                    b.ToTable("tenant_notification_recipients", (string)null);
                });

            modelBuilder.Entity("Ecosys.Domain.Entities.TenantNotificationSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.EmailDeliveryLog", b =>
                {
                    b.HasOne("Ecosys.Domain.Entities.EmailOutboxMessage", "OutboxMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformInvoice", b =>
                {
                    b.HasOne("Ecosys.Domain.Entities.PlatformQuotation", "Quotation")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformInvoiceLine", b =>
                {
                    b.HasOne("Ecosys.Domain.Entities.PlatformInvoice", "Invoice")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.PlatformLead", b =>
                {
                    b.HasOne("Ecosys.Domain.Entities.Tenant", "ConvertedTenant")
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.TenantNotificationRecipient", b =>
                {
                    b.HasOne("Ecosys.Domain.Entities.Tenant", "Tenant")
                        .WithMany("TenantNotificationRecipients")
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.TenantNotificationSetting", b =>
                {
                    b.HasOne("Ecosys.Domain.Entities.Tenant", "Tenant")
                        .WithMany("TenantNotificationSettings")
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ecosys.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Navigation("PlatformExpenses");

                    b.Navigation("PlatformInvoices");

                    b.Navigation("PlatformPayments");

                    b.Navigation("PlatformQuotations");
                    ...
                    b.Navigation("TenantNotificationRecipients");

                    b.Navigation("TenantNotificationSettings");
